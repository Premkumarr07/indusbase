...
export const metadata: Metadata = {
  applicationName: 'indusbase Design System',
  title: 'indusbase Design System',
  description: 'Design resources for building consistent user experiences at indusbase.',
